                ...
                <div className="flex flex-col md:flex-row items-center about-content">
                    ...
                    <div className="md:w-2/3 md:pl-12">
                        ...
                        <p className="text-lg mb-6">
                            I'm a passionate software engineer with 5+ years of experience building web and mobile applications. My
                            journey in tech started when I built my first website at 15, and I've been hooked ever since.
                        </p>
                        <p className="text-lg mb-6">
                            I specialize in JavaScript ecosystems (React, Node.js) but I'm always exploring new technologies. What
                            excites me most is solving complex problems with elegant, maintainable solutions.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {['JavaScript', 'TypeScript', 'React', 'Node.js', 'Python', 'AWS', 'Docker', 'SQL'].map((skill, idx) => (
                                <span
                                    key={idx}
                                    className="skill-pill bg-red-100 text-red-800 px-4 py-2 rounded-full font-medium"
                                >
                                    {skill}
                                </span>
                            ))}
